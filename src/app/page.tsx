    ...
    <div>
      ...
      <section className="py-16 sm:py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 p-6 sm:p-8 rounded-2xl bg-linear-to-r from-[#0B1E3D] to-[#162C52] text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-[#0B1E3D]/10">
            <div className="space-y-1 text-center md:text-left">
              ...
              <p className="text-slate-300 text-sm max-w-2xl">
                We configure grade-specific hardware and live teaching modules suited to your academic calendar.
              </p>
            </div>
            <Link
              href="/our-company#contact"
              className="px-6 py-3 rounded-xl text-sm font-bold text-[#0B1E3D] bg-white hover:bg-slate-100 transition-colors shadow-md shrink-0"
            >
