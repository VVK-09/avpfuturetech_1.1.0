    ...
    <div className="bg-white">
      ...
      <section className="py-16 sm:py-24 bg-linear-to-b from-[#F7F9FC] via-white to-[#F7F9FC] border-b border-[#E2E8F0] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-[#DCEBFF] text-[#1E63D6] border border-[#BFDBFE] mb-5 shadow-xs">
            <Sparkles className="w-3.5 h-3.5 text-[#1E63D6]" />
            <span>Hands-on Experiential Workshops</span>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-white relative overflow-hidden" id="schools">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 pb-6 border-b border-slate-100">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#DCEBFF] text-[#1E63D6] text-xs font-extrabold uppercase tracking-wider mb-3">
                <GraduationCap className="w-4 h-4" />
                Category A &bull; Grades 1 to 10
              </div>
      ...
      <section className="py-16 sm:py-24 bg-[#0B1E3D] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-blue-500/20 text-sky-300 border border-blue-400/30 mb-4 backdrop-blur-md">
              <Wrench className="w-3.5 h-3.5 text-sky-300" />
              <span>Tangible Equipment & Workbench Experience</span>
            </div>
      ...
      <section className="py-16 sm:py-24 bg-[#F7F9FC] border-y border-[#E2E8F0] relative overflow-hidden" id="colleges">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 pb-6 border-b border-slate-200">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0B1E3D] text-white text-xs font-extrabold uppercase tracking-wider mb-3">
                <Building2 className="w-4 h-4 text-sky-400" />
                Category B &bull; Engineering &amp; Science Undergrads
              </div>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#0B1E3D] font-heading">
      ...
      <section className="py-16 bg-linear-to-r from-[#0B1E3D] via-[#162C52] to-[#1E63D6] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-3xl space-y-6 relative z-10">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-sky-200 text-xs font-bold uppercase tracking-wider border border-white/20">
            <Sparkles className="w-3.5 h-3.5 text-amber-300" />
            <span>Book Your Campus Slots Early</span>
          </div>
